# Generated by Django 2.2.4 on 2019-09-26 05:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circlescore', '0005_auto_20190907_1312'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding_status_uuid', models.UUIDField(default=uuid.UUID('d5b195a4-d275-4571-b01f-04908e48e7c6'), editable=False, unique=True, verbose_name='Funding Status UUID')),
                ...
                ('created_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fund_status_created_by', to='circlescore.HikayaUser', verbose_name='Created By')),
                ('modified_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fund_status_modified_by', to='circlescore.HikayaUser', verbose_name='Modified By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow_level1_code', models.CharField(blank=True, max_length=100, verbose_name='Workflow Level 1 Code')),
                ('description', models.TextField(blank=True, max_length=765, verbose_name='Workflow Level 1 Description')),
                ...
                ('created_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wfl1_created_by', to='circlescore.HikayaUser', verbose_name='Created By')),
                ('funding_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.FundingStatus', verbose_name='Funding Status')),
                ('modified_by', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wfl1_modified_by', to='circlescore.HikayaUser', verbose_name='Modified By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=765, verbose_name='Workflow Level 2/3 Description')),
                ...
                ('implementation_location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.Location', verbose_name='Implementation Location Tag')),
                ...
                ('office_location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.Office', verbose_name='Office Location Tag')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workflow_level3s', to='circlescore.WorkflowLevel2')),
                ('staff_responsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.Contact', verbose_name='Staff Responsible')),
        ...
        migrations.RenameField(
            ...
            old_name='organization_label',
            new_name='account_label',
        ),
        migrations.AddField(
            model_name='country',
            name='created_by',
        ...
        migrations.AlterField(
            model_name='workspace',
            name='workflow_level_4',
            field=models.CharField(default='Task', max_length=36, verbose_name='Organization/Account Label'),
        ),
        migrations.CreateModel(
            name='WorkflowStatus',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow_level2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.WorkflowLevel2', verbose_name='Workflow Level 2')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.WorkflowLevel2Type', verbose_name='Workflow Level 2 Type'),
        ),
        migrations.AddField(
            model_name='workflowlevel2',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(max_length=100, null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.WorkflowStatus', verbose_name='Workflow Status'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='circlescore.WorkflowLevel1Type', verbose_name='Workflow Level 1 Type'),
        ),
        migrations.AddField(
            model_name='workflowlevel1',
            name='workflow_status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('funding_status_uuid', models.UUIDField(db_index=True, default=uuid.UUID('d5b195a4-d275-4571-b01f-04908e48e7c6'), editable=False, verbose_name='Funding Status UUID')),
                ('status', models.CharField(max_length=165, verbose_name='Funding Status')),
                ('create_date', models.DateTimeField(blank=True, null=True, verbose_name='Create Date')),
                ('modified_date', models.DateTimeField(blank=True, null=True, verbose_name='Modified Date')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('approval_uuid', models.UUIDField(db_index=True, default=uuid.UUID('a40f1f11-f6c1-4416-8c2c-5bd9b22d62f1'), editable=False, verbose_name='Approval UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='circlescore.AccountType', verbose_name='Account Type')),
                ('workspace', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='circlescore.Workspace')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('organization_type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='circlescore.AccountType')),
                ('parent_organization', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='circlescore.Account')),
                ('workspace', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='circlescore.Workspace')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('approval_uuid', models.UUIDField(default=uuid.UUID('a40f1f11-f6c1-4416-8c2c-5bd9b22d62f1'), editable=False, unique=True, verbose_name='Approval UUID')),
                ('name', models.CharField(max_length=165, verbose_name='Approval Name')),
                ('description', models.TextField(blank=True, max_length=765, verbose_name='Approval Description')),
                ('create_date', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='Create Date')),
                ('modified_date', models.DateTimeField(blank=True, null=True, verbose_name='Modified Date')),
